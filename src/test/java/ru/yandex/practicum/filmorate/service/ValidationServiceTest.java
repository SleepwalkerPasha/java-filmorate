...
import static ru.yandex.practicum.filmorate.service.ValidationService.*;
...
class ValidationServiceTest {
    ...
    void validateFilmSuccess() {
        Assertions.assertDoesNotThrow(() -> validateFilm(new Film(1L, "sfdfsf", "adfsdfs",
                LocalDate.of(2002, 12, 12), new MpaRating(1L, "name"), 5, 120)));
    }
    ...
    void validateFilmFailReleaseDate() {
        Film film = new Film(1L, "sdfsdfsfs", "asdfsf",
                LocalDate.of(1800, 12, 12), new MpaRating(1L, "name"), 5, 120);
